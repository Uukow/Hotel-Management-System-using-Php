...
// Register the user
function registerCompus($conn){
    extract($_POST);
    $data = array();

    $query = "CALL sp_compus('','$cName','$location','$phone')";
...
function update_compus($conn){
    extract($_POST);

    $data = array();

    // Building the query and calling the stored procedure
    $query = "CALL sp_compus('$id','$cName','$location','$phone')";
...
function get_compus($conn){

    $data = array();
    $array_data = array();
    $query = "SELECT * FROM compus";
    $result = $conn->query($query);
...
function get_compus_info($conn){
    extract($_POST);

    $data = array();
    $array_data = array();
    
    $query = "SELECT * FROM `compus` WHERE id = '$id'";
    $result = $conn->query($query);
...
function delete_compus_info($conn){
    extract($_POST);

    $data = array();
    $array_data = array();
    
    $query = "DELETE FROM `compus` WHERE id = '$id'";
    $result = $conn->query($query);
